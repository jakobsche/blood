...
begin
  with Form1 do begin
    ...
    HCTSeries.YValue[i] := 42.2;
    MCVSeries.YValue[i] := 96.1;
    MCHSeries.YValue[i] := 32.6;
    MCHCSeries.YValue[i] := 33.9;
    PLTSeries.YValue[i] := 121;
    LYMpctSeries.YValue[i] := 23.2;
    MXDpctSeries.YValue[i] := 15.2;
    NEUTpctSeries.YValue[i] := 61.6;
    ...
    PCTSeries.YValue[i] := -0.13; {Vorzeichen unsicher}
